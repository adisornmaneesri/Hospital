...
if ($result->rowCount()>0) {
    ...
    msgbox('เกิดข้อผิดพลาด','admit_diagnose.php');
}
?>
          					...
          					<tbody>
          						...
          						<tr>
          							...
          							<td style="text-align: center;">
          								<a href="edit_admit_diagnose.php?act=addmedic&mid=<?php echo $rs['medical_id']; ?>" class="btn btn-primary"><i class='fa fa-check'></i> เลือก</a>
          							</td>
          						</tr>
          						<?php } } ?>
          					</tbody>
