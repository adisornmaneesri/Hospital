...
$query = 'select * from medical where active = 1 ';
$result = $con->prepare($query);
$result->execute();
if ($result->rowCount()>0) {
    $rs = $result->fetch();
} else {
    msgbox('เกิดข้อผิดพลาด','add_admit_diagnose.php');
}
?>
          					...
          					<tbody id="myTable">
          						...
          						<tr>
          							...
          							<td style="text-align: center;">
          								<a href="add_admit_diagnose.php?act=addmedic&mid=<?php echo $rs['medical_id']; ?>" class="btn btn-primary"><i class='fa fa-check'></i> เลือก</a>
          							</td>
          						</tr>
          						<?php } } ?>
          					</tbody>
