...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>รายการสั่งซื้อยาและอุปกรณ์ทางการแพทย์</h1>
            <ol class="breadcrumb">
                <li><a href="home.php"><i class="fa fa-home"></i> หน้าแรก</a></li>
                <li class="active">รายการสั่งซื้อยาและอุปกรณ์ทางการแพทย์</li>
            </ol>
        </section>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="table1" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php 
                                        $query = 'select * from medical_orders_views ';
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="btn-group">
                                                ...
                                                <?php if ($rs['status']==1) { ?>
                                                <a href="edit_medical_orders.php?id_edit=<?php echo $rs['orders_id']; ?>" class="btn btn-info"><i class="fa fa-edit"></i> แก้ไข</a>
                                                <a href="#" onclick="if(confirm('คุณแน่ใจหรือว่าต้องการลบข้อมูลนี้')==true) { window.location='del_orders.php?id_del=<?php echo $rs['orders_id']; ?>'; }" class="btn btn-danger"><i class="fa fa-trash"></i> ลบ</a>
                                                <?php } ?>
                                            </div>
                                        </td>
                                    </tr>
