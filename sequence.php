...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>อาการผู้ป่วยเบื้องต้น</h1>
            <ol class="breadcrumb">
                <li><a href="home.php"><i class="fa fa-home"></i> หน้าแรก</a></li>
                <li class="active">อาการผู้ป่วยเบื้องต้น</li>
            </ol>
        </section>
        ...
        <section class="content container-fluid">
            <div class="box box-primary color-palette-box">
                <div class="box-header with-border">
                    <a href="add_sequence.php" class="btn btn-success"><i class="fa fa-plus"></i> เพิ่มอาการผู้ป่วยเบื้องต้น</a>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <table id="table1" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php 
                                        $query = 'select * from sequence_views order by patient_id desc ';
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"><?php echo $rs['to_department_name']; ?></td>
                                        <td style="text-align: center;">
                                            <div class="btn-group">
                                                <a href="edit_sequence.php?id_edit=<?php echo $rs['sequence_id']; ?>" class="btn btn-info"><i class="fa fa-edit"></i> แก้ไข</a>
                                                <a href="#" onclick="if(confirm('คุณแน่ใจหรือว่าต้องการลบข้อมูลนี้')==true) { window.location='del_sequence.php?id_del=<?php echo $rs['sequence_id']; ?>'; }" class="btn btn-danger"><i class="fa fa-trash"></i> ลบ</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php } } ?>
