        ...
        <section class="content container-fluid">
            <div class="box box-primary color-palette-box">
                <div class="box-body">
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="del_diagnose_medical.php?id_del=<?php echo $rs2['diagnose_medic_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php } } ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_diagnose.php?act=removemedic&mid=<?php echo $mid; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php } } } ?>
                                </tbody>
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="del_diagnose_service.php?id_del=<?php echo $rs2['diagnose_service_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php } } ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_diagnose.php?act=removeservice&ser_id=<?php echo $ser_id; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php } } } ?>
                                </tbody>
                    ...
                    <hr>
                    <form action="edit_diagnose2.php" id="mainForm" method="post" class="form">
                    <h4>4.วินิจฉัยโรค</h4>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    function medicalModal(id_edit) {
        ...
        $('#medical-modal').load('edit_diagnose_medical_views.php', data, function(){
    ...
    function serviceModal(id_edit) {
        ...
        $('#service-modal').load('edit_diagnose_service_views.php', data, function(){
