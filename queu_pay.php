...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>ผู้ป่วยรอชำระเงิน</h1>
            <ol class="breadcrumb">
                <li><a href="home.php"><i class="fa fa-home"></i> หน้าแรก</a></li>
                <li class="active">ผู้ป่วยรอชำระเงิน</li>
            </ol>
        </section>
                            ...
                            <table id="table1" class="table table-striped table-hover">
                                <thead>
                                    <tr class="bg-info">
                                        ...
                                        <th style="text-align: center; font-weight: bold;">ค่ารักษาพยาบาล</th>
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        where to_department = 3 and status = 1  
                                        order by save_date desc ';
                                        $result = $con->prepare($query);
                                        $result->execute();
                                        $t = null;
                                        if ($result->rowCount()>0) { $i=0; $j=0;
                                            while ($rs = $result->fetch()) {
                                                ...
                                                $rs2 = $result2->fetch();
                                                $sum_total = $rs2['sum_drug'] + $rs2['sum_service'];
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><?php echo number_format($sum_total,2); ?></td>
                                        <?php  if ($t != '' && in_array($rs['hn'], $t)) { } else { ?>
                                        <td style="text-align: center;">
                                            <div class="btn-group">
                                                <a href="add_payment.php?sid=<?php echo $rs['sequence_id']; ?>&qid=<?php echo $rs['queu_id']; ?>&did=<?php echo $rs['diagnose_id']; ?>" class="btn btn-info">รับชำระเงิน</a>
                                            </div>
                                        </td>
                                        <?php 
                                    $t[$j] = $rs['hn'];
