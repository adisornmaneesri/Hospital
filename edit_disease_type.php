...
$query = 'select * from disease_type where type_id = :id';
$result = $con->prepare($query);
$result->execute(['id' => $id_edit]);
if ($result->rowCount()>0) {
    $rs = $result->fetch();
} else {
    msgbox('เกิดข้อผิดพลาด','disease_type.php');
}
?>
<!DOCTYPE html>
<html>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>แก้ไขข้อมูลประเภทโรค</h1>
            <ol class="breadcrumb">
                <li><a href="home.php"><i class="fa fa-dashboard"></i> หน้าแรก</a></li>
                <li><a href="disease_type.php"> ประเภทโรค</a></li>
                <li class="active"> แก้ไขข้อมูลประเภทโรค</li>
            </ol>
        </section>

        <!-- Main content -->
        <section class="content container-fluid">
            <form action="edit_disease_type2.php" method="post" class="form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="กรอกชื่อประเภทโรค" value="<?php echo $rs['name']; ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="box-footer">
                    <input type="hidden" name="id_edit" value="<?php echo $rs['type_id']; ?>">
