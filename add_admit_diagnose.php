...
if ($aid != '') {
    ...
    if ($result->rowCount() > 0) {
        $rs = $result->fetch();
        $_SESSION['aid'] = $rs['admit_patien_id'];
        $_SESSION['sid'] = $rs['sequence_id'];
        $_SESSION['pid'] = $rs['patient_id'];
    } else {
        msgbox('ไม่พบข้อมูลผู้ป่วย กรุณาตรวจสอบใหม่อีกครั้ง', 'admit_patient.php');
    }
}
/*************************************************************/
//medical management
            ...
            <section class="content container-fluid">
                <div class="box box-primary color-palette-box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="oxygen">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="breat_rate">
                                </div>
                            </div>
                        </div>
                        <hr>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="add_admit_diagnose.php?act=removemedic&mid=<?php echo $mid; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                            <?php }
                                                }
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($_SESSION['service'])) {
                                                $sum_price = $sum_total = $i = 0;
                                                foreach ($_SESSION['service'] as $ser_id => $qty) {
                                                    $i++;
                                            ...
                                            ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="add_admit_diagnose.php?act=removeservice&ser_id=<?php echo $ser_id; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                            <?php }
                                                }
                        ...
                        <hr>
                        <form action="add_admit_diagnose2.php" id="mainForm" method="post" class="form" enctype="multipart/form-data">
                            <h4>6.ส่งต่อ</h4>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="dept" class="form-control" required>
                                            <?php
                                            $query2 = 'select * from department where department_id = 3';
                                            $result2 = $con->prepare($query2);
                                            $result2->execute();
                                            if ($result2->rowCount() > 0) {
                                                while ($rs2 = $result2->fetch()) {
                            ...
                            <div class="box-footer">
                                ...
                                <input type="hidden" name="oxy" id="oxy">
                                <input type="hidden" name="ber" id="ber">
...
<script type="text/javascript">
    ...
    function medicalModal() {
        ...
        $('#medical-modal').load('admit_diagnose_medical_views.php', data, function() {
    ...
    function serviceModal() {
        ...
        $('#service-modal').load('admit_diagnose_service_views.php', data, function() {
