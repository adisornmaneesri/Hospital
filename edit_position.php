...
if ($result->rowCount()>0) {
    ...
    msgbox('เกิดข้อผิดพลาด','position.php');
}
?>
<!DOCTYPE html>
<html>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"> แก้ไขข้อมูลตำแหน่ง</li>
            </ol>
        </section>

        <!-- Main content -->
        <section class="content container-fluid">
            <form action="edit_position2.php" method="post" class="form" enctype="multipart/form-data">
            <div class="box box-primary color-palette-box">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name" class="control-label"> ตำแหน่ง</label>
                ...
                <div class="box-footer">
                    <input type="hidden" name="id_edit" value="<?php echo $rs['position_id']; ?>">
                    <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> บันทึก</button>
                    <a href="position.php" class="btn btn-warning"><i class="fa fa-reply"></i> ยกเลิก</a>
                </div>
            </div>
            </form>
        </section>
