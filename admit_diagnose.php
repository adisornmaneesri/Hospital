...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>ข้อมูลการตรวจรักษาผู้ป่วยใน</h1>
            <ol class="breadcrumb">
                <li><a href="home.php"><i class="fa fa-home"></i> หน้าแรก</a></li>
                <li class="active">ข้อมูลการตรวจรักษาผู้ป่วยใน</li>
            </ol>
        </section>
                            ...
                            <table id="table1" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        $result->execute();
                                        if ($result->rowCount()>0) { $pay_status='ยังไม่ชำระเงิน';
                                            while ($rs = $result->fetch()) { 
                                                $query2 = 'select * from payment where diagnose_id = :id';
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;"><?php echo $pay_status; ?></td>
                                        <td style="text-align: center;">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a href="edit_admit_diagnose.php?id_edit=<?php echo $rs['diagnose_id']; ?>">แก้ไข</a></li>
                                                    <li class="divider"></li>
