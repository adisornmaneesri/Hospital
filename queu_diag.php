                            ...
                            <table id="table1" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        where to_department = 2 and status = 1  
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="btn-group">
                                                <a href="add_diagnose.php?sid=<?php echo $rs['sequence_id']; ?>&qid=<?php echo $rs['queu_id']; ?>" class="btn btn-info">เรียกคิว</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php } } ?>
