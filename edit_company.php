...
if ($result->rowCount()>0) {
    ...
    msgbox('เกิดข้อผิดพลาด','company.php');
}
?>
<!DOCTYPE html>
<html>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>แก้ไขบริษัทผู้จำหน่ายยา</h1>
            <ol class="breadcrumb">
                <li><a href="home.php"><i class="fa fa-dashboard"></i> หน้าแรก</a></li>
                <li><a href="medical.php"> แก้ไขบริษัทผู้จำหน่ายยา</a></li>
            </ol>
        </section>

        <!-- Main content -->
        <section class="content container-fluid">
            <form action="edit_company2.php" method="post" class="form">
            <input type="hidden" class="form-control" name="id_edit" value="<?php echo $rs['company_id']; ?>" required>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_company" value="<?php echo $rs['name_company']; ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="phone" value="<?php echo $rs['phone']; ?>" required>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <textarea name="address" rows="4" class="form-control" > <?php echo $rs['address_company']; ?> </textarea>
                        </div>
                    </div>
