...
<body onload="window.print()">
	...
	<table width="1024" align="center" border="0">
		<tr>
			<td>
				<h2 style="text-align: center;">ใบจ่ายยา</h2>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				...
				<table width="80%" align="center" border="0">
					<tr>
						<td style="width: 50%; height:30px;"><b>วัน-เวลาที่จ่ายยา:</b> <?php echo thaidatetime($rs['save_date']); ?></td>
						<td><b>ผู้จ่ายยา:</b> <?php echo $rs['employee_name']; ?></td>
					</tr>
				</table>
			</td>
		</tr>
