...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>เพิ่มข้อมูลทะเบียนโรค</h1>
            <ol class="breadcrumb">
                <li><a href="home.php"><i class="fa fa-dashboard"></i> หน้าแรก</a></li>
                <li><a href="disease.php"> ทะเบียนโรค</a></li>
                <li class="active"> เพิ่มข้อมูลทะเบียนโรค</li>
            </ol>
        </section>

        <!-- Main content -->
        <section class="content container-fluid">
            <form action="add_disease2.php" method="post" class="form" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control" required>
                                    ...
                                    <?php 
                                        $query2 = 'select * from disease_type';
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="กรอกชื่อโรค" required>
                            </div>
                        </div>
                    </div>
                </div>
