...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>ผู้ป่วยรอจ่ายยา</h1>
            <ol class="breadcrumb">
                <li><a href="home.php"><i class="fa fa-home"></i> หน้าแรก</a></li>
                <li class="active">ผู้ป่วยรอจ่ายยา</li>
            </ol>
        </section>
                            ...
                            <table id="table1" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        where to_department = 4 and status = 1  
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <div class="btn-group">
                                                <a href="add_pay_medical.php?sid=<?php echo $rs['sequence_id']; ?>&qid=<?php echo $rs['queu_id']; ?>" class="btn btn-info">บันทึกจ่ายยา</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php } } ?>
